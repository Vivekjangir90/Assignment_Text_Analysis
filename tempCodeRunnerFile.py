...
for num,url_index in enumerate(df_urls["URL"]):
    ...
    if num <= 41:
        ...
        # complex_all_words = total_words_before_clean
        # Print the number of sentences and words
        # print("Number of sentences:", len(total_sentences))
        # print("Number of words:", len(total_words_before_clean))
        ...
        Complex_words_Count  = syllables_vowels_count/((len(positive) / (len(negative)+0.0001)) +0.0001)
